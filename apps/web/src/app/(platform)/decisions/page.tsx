    ...
    <div className="space-y-6">
      <section className="glass-panel rounded-[2rem] p-6 md:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <p className="text-xs uppercase tracking-[0.28em] text-accent">Institutional Memory</p>
        ...
        <div className="grid gap-4 sm:grid-cols-[1fr_1fr_auto_auto]">
          <label className="relative">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-line bg-white/5 px-10 py-3 text-sm outline-none placeholder:text-muted"
            />
          </label>
      ...
      {showCreateDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="glass-panel rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto m-4">
            ...
            <form onSubmit={handleCreateSubmit} className="p-6 space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label className="block text-sm text-muted mb-1">Subsystem</label>
                  <select
              ...
              <div className="space-y-2">
                <label className="block text-sm text-muted mb-1">Context</label>
                <textarea
              ...
              <div className="space-y-2">
                <label className="block text-sm text-muted mb-1">Rationale</label>
                <textarea
              ...
              <div className="space-y-2">
                <label className="block text-sm text-muted mb-1">Alternatives Considered (one per line)</label>
                <textarea
                  value={formData.alternatives}
                  onChange={(e) => setFormData({ ...formData, alternatives: e.target.value })}
                  placeholder="Option A: ...\nOption B: ..."
                  rows={3}
                  className="w-full rounded-2xl border border-line bg-white/5 px-4 py-3 text-sm outline-none font-mono text-sm"
                />
              </div>

              <div className="space-y-2">
                <label className="block text-sm text-muted mb-1">Consequences (optional)</label>
                <textarea
              ...
              <div className="space-y-2">
                <label className="block text-sm text-muted mb-1">Related Task IDs (one per line, optional)</label>
                <textarea
          ...
          <div className="glass-panel rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
                ...
                <span className={cn(
                  ...
                  (() => {
                    const config: Record<DecisionStatus, string> = {
                      ...
                      DEFERRED: "text-slate-400 bg-slate-400/10",
                    };
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-xs text-muted pt-4 border-t border-line/40">
            ...
            <div className="p-6 border-t border-line/40 flex justify-end">
