...
const features = [
  {
    icon: Orbit,
    title: "subsystemOperations",
    description: "subsystemOperationsDesc",
  },
  {
    icon: Sparkles,
    title: "aiIntelligence",
    description: "aiIntelligenceDesc",
  },
  {
    icon: TimerReset,
    title: "realExecutionVisibility",
    description: "realExecutionVisibilityDesc",
  },
  {
    icon: ShieldCheck,
    title: "productionGovernance",
    description: "productionGovernanceDesc",
  },
];
    ...
    <main className="min-h-screen bg-orbital-grid bg-orbital-grid bg-top px-6 py-8">
      <div className="mx-auto max-w-7xl">
        <section className="glass-panel relative overflow-hidden rounded-[2rem] p-8 md:p-12">
          ...
          <p className="text-xs uppercase tracking-[0.36em] text-accent">{t("appName")}</p>
